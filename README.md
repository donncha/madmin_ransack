...
- If you need to define custom search logics you can skip prepending the module (`MadminRansack::Searchable`) and create your own search query in a controller (but you need to assign the Ransack search object to `@ransack_results` for the filters partial), for example:
